    ...
    <section class="content">
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-lg-8">
                <form method="POST" action="/dashboard/inventories/{{ $inventory->slug }}" class="mb-5" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="mb-3">
                      <label for="title" class="form-label">Title</label>
                      <input type="text" class="form-control" @error('title') is-invalid @enderror id="title" name="title" required autofocus value="{{ old('title', $inventory->title) }}">
                      @error('title')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="slug" name="slug" required value="{{ old('slug',$inventory->slug) }}">
                    </div>
